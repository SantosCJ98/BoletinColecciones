		...
		case 4:
			...
			Set<Pelicula> videoclub6 = new HashSet<>();
					...
					public int compare(Pelicula peli1, Pelicula peli2) {
						...
						if (peli1.getClave().getGenero().getCodigo() == 'F' && peli2.getClave().getGenero().getCodigo() == 'T') {
							
							return -1;
							
						}
						
						else if (peli1.getClave().getGenero().getCodigo() == 'F' && peli2.getClave().getGenero().getCodigo() == 'C') {
								
								return -1;
								
							}
						
						else if (peli1.getClave().getGenero().getCodigo() == 'T' && peli2.getClave().getGenero().getCodigo() == 'C') {
							
							return -1;
							
						}
						
						else if (peli1.getClave().getGenero().getCodigo() == 'T' && peli2.getClave().getGenero().getCodigo() == 'F') {
							
							return 1;
							
						}
						
						else if (peli1.getClave().getGenero().getCodigo() == 'C' && peli2.getClave().getGenero().getCodigo() == 'F') {
							
							return 1;
							
						}
						
						else if (peli1.getClave().getGenero().getCodigo() == 'C' && peli2.getClave().getGenero().getCodigo() == 'T') {
